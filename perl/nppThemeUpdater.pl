...
16          => { name => "KEYWORD2",        keywordClass => "instre2",   }, ##     <WordsStyle name="USER1" styleID="16" fgColor="0000FF" bgColor="FFFFFF" fontName="" fontStyle="1" fontSize="" keywordClass="instre2" />
...
19          => { name => "USER1",           keywordClass => "type3",     }, ##     <WordsStyle name="KEYWORD2" styleID="19" fgColor="800080" bgColor="FFFFFF" fontName="" fontStyle="0" fontSize="" keywordClass="type3" />
